    ...
    <div className="app-shell">
      <aside className="sidebar">
        <div className="brand" onClick={() => setActiveNav("Classes")}>
          <div className="brand-mark lessoncue-mark"><img src="/favicon.svg" alt="" aria-hidden="true" /></div>
