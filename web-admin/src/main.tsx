...
function Shell({ view, setView, username, role, onLogout, notice, setNotice }: {
  ...
  return <><a className="skip-link" href="#main-content">Skip to main content</a><div className="app-shell">
    <aside className="sidebar">
      ...
      <div className="sidebar-foot"><div className="server-online"><span className="status-dot" /><div><strong>Server online</strong><small>{location.host}</small></div></div><button className="account-button" onClick={onLogout}>{username}<span>{role} · Sign out</span></button></div>
    </aside>
