...
type Bootstrap = {
  ...
  storage: StorageStatus; update: UpdateStatus; localAddress: LocalAddressStatus;
  counts: { classes: number; lessons: number; media: number; screens: number };
};
type Organization = { id: string; name: string; siteName: string; timeZone: string; weekStartsOn: string; defaultLessonDurationMinutes: number; defaultRetentionDays: number; primaryColor: string; accentColor: string; welcomeMessage: string; storageLimitBytes: number };
