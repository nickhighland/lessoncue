...
14) enable server-side transcoding, like services like Plex offer, to ensure greater video compatibility.
15) Expand the folders and tags for media, allowing users to upload to administrator-determined folders and assign admin-determined tags for easier grouping.
16) Focus on ## Editing and playback section.
