...
- Replace the development pairing PIN and protect service logs.
...
- Add browser sessions, role permissions, anti-CSRF, CSP, and signed media URLs before exposing the administration API beyond a controlled evaluation.
